...
## Aider integration note

If your project already has a `CONVENTIONS.md`, append the content above to it. Or reference this file in `.aider.conf.yml`:

```yaml
read:
  - osop-agent-rules/aider/CONVENTIONS.md
```
